  ...
  return (
    <>
      <Hero
        ...
        capsuleLink="https://github.com/dominictayloruk/multi-tenant-starter-template"
        title="Multi Tenant Starter Template built on Next.js"
        subtitle="Built for developers, by developers. Next.js + Shadcn UI + Stack Auth"
        primaryCtaText="Get Started"
        primaryCtaLink={stackServerApp.urls.signUp}
        secondaryCtaText="GitHub"
        secondaryCtaLink="https://github.com/dominictayloruk/multi-tenant-starter-template"
        secondaryCtaIcon={<GitHubLogoIcon className="h-4 w-4" />}
        credits={
          <>
            Crafted with ❤️ by{' '}
            <a
